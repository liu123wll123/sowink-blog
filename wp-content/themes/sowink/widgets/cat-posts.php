...
function CategoryPosts() {
	parent::WP_Widget(false, $name='P75 - SoWink');
}
...
function widget($args, $instance) {
	...
	?>
		<div class="cat-post-item">
			<a class="comments-link comments-link-side" href="<?php the_permalink() ?>#comments" title="Comments"><?php comments_number('0','1','%'); ?></a>
			
			<h2 class="post-title"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h2>
			<p class="post-meta">Posted on <?php the_time('F j, Y'); ?></p>
