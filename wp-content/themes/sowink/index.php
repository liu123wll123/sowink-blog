...
<div id="blog">
	<div id="main">
		...
		<div id="post-<?php the_ID(); ?>" class="post-item">		
			<h2 class="post-title"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a> <?php edit_post_link('- Edit'); ?></h2>
			...
			<div <?php post_class('') ?>>
                ...
                <div id="socials">
                    ...
                    <div id="fb-root"></div><script src="http://connect.facebook.net/en_US/all.js#appId=217920384899232&amp;xfbml=1"></script><fb:like href="<?php echo get_permalink(); ?>" send="false" layout="button_count" width="110" show_faces="false" font="trebuchet ms"></fb:like>
                </div>
			</div>
